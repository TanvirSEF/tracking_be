...
from models import User, AffiliateRequest, Affiliate, Referral, SystemConfig, EmailVerificationToken
...
async def init_db():
    ...
    try:
        ...
        await init_beanie(
            database=database,
            document_models=[User, AffiliateRequest, Affiliate, Referral, SystemConfig, EmailVerificationToken]
        )
